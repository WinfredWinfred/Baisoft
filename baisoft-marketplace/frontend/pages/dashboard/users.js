...
function UsersPage() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      await apiService.delete(`/business/users/${deleteUserId}/`);
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Role
                        <span className="ml-2 text-xs text-gray-500">(Admins can assign any role)</span>
                      </label>
                      <select
                        value={formData.role}
                        ...
                        className="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900"
                      >
                        <option value="viewer">Viewer - View approved products only</option>
                        <option value="editor">Editor - Create and edit products</option>
                        <option value="approver">Approver - Approve pending products</option>
                        <option value="admin">Admin - Full access to all features</option>
                      </select>
                      <p className="mt-1 text-xs text-gray-500">
                        Admins have full control and can perform all actions
                      </p>
                    </div>
                  </div>
                </div>
